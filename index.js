...
if(process.env.MSG){
cafmsg1 = process.env.MSG;
   // cafmsg1 = cafmsg1.substring(0, 145);
}
...
cafbot.on('update', async function (msg) {
    ...
    if (!(stopg.indexOf(thisg) > -1)) {
      ...
      await cafbot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg1}`, { replyToMessage: msg[0].message.message_id, webPreview: false ,parse_mode: 'Markdown' });
    ...
    //  return cafbot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg2}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
...
cafbotalt.on('update', async function (msg) {
    ...
    if (!(stopg.indexOf(thisg) > -1)) {
      ...
      await cafbotalt.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg1}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
    ...
    //  return cafbotalt.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg2}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
...
caf1bot.on('update', async function (msg) {
    ...
    if (!(stopg.indexOf(thisg) > -1)) {
      ...
      await caf1bot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg1}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
    ...
    //  return caf1bot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg2}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
...
caf2bot.on('update', async function (msg) {
    ...
    if (!(stopg.indexOf(thisg) > -1)) {
      ...
      await caf2bot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg1}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
    ...
    //  return caf2bot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg2}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
...
caf3bot.on('update', async function (msg) {
    ...
    if (!(stopg.indexOf(thisg) > -1)) {
      ...
      await caf3bot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg1}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
    ...
    //  return caf3bot.sendMessage(msg[0].message.chat.id, `Hi , ${un} !!  ${cafmsg2}`, { replyToMessage: msg[0].message.message_id, webPreview: false });
